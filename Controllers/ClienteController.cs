...
namespace MarcosAraujo.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public ClienteController(MyDbVendas context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Clientes != null ? 
                          View(await _context.Clientes.OrderBy(x => x.Nome).AsNoTracking().ToListAsync()) :
                          Problem("Entity set 'MyDbVendas.Clientes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyDbVendas.Clientes'  is null.");
            }
            var cliente = await _context.Clientes.FindAsync(id);
            if (cliente != null)
            {
