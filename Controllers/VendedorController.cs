...
namespace MarcosAraujo.Controllers
{
    public class VendedorController : Controller
    {
        ...
        public VendedorController(MyDbVendas context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Vendedors != null ? 
                          View(await _context.Vendedors.OrderBy(x => x.Nome).ToListAsync()) :
                          Problem("Entity set 'MyDbVendas.Vendedors'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyDbVendas.Vendedors'  is null.");
            }
            var vendedor = await _context.Vendedors.FindAsync(id);
            if (vendedor != null)
            {
        ...
        {
          return (_context.Vendedors?.Any(e => e.VendedorId == id)).GetValueOrDefault();
        }
    }
}
